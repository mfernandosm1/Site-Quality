(()=>{
  ...
  const iso=d=>window.QualityDate?.dateKey?.(d)||(()=>{const year=d.getFullYear(),month=String(d.getMonth()+1).padStart(2,'0'),day=String(d.getDate()).padStart(2,'0');return `${year}-${month}-${day}`})();
