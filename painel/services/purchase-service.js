...
export default class PurchaseService {
  ...
  searchProducts(query=''){return this.productCatalog().filter(p=>p.active&&searchMatches([p.name,p.code,p.sku,p.barcode,p.ncm,p.reference,p.brand,p.model].join(' '),query)).slice(0,120);}
