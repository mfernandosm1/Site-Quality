...
## Refinamento visual — Aniversariantes

- Removida a faixa informativa com o texto “Quality ERP → aniversariantes do dia → WhatsApp/Inbox → histórico de envio”.
- A explicação sobre o fluxo direto Quality ERP → WhatsApp/Inbox passou para um ícone `i` ao lado do título “Automação de aniversariantes”.
- A explicação de que mensagem e horário podem ser alterados pelo painel passou para um ícone `i` ao lado do título “Mensagem e horário”.
- Objetivo: reduzir poluição visual e manter as orientações disponíveis apenas quando necessárias.

## 22/08/2026 — Refino Aniversariantes + Parcelamento no recebimento

### Aniversariantes
- Unificados os blocos “Automação de aniversariantes” e “Hoje” em um único card.
- O card único passa a concentrar status da automação, horário, conexão do WhatsApp e totais do dia.

### Contas a Receber
- No recebimento, formas compatíveis com parcelamento (cartão/crédito/crediário) passam a exibir o campo “Parcelas”.
- Permite registrar de 1x a 24x sem alterar a quantidade de parcelas do título original; trata-se da condição da forma usada na baixa.
- A quantidade de parcelas fica gravada no recebimento e no pagamento financeiro.
- Histórico e comprovante passam a exibir a quantidade de parcelas quando maior que 1.
